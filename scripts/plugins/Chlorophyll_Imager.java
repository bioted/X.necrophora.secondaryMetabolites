...
public class Chlorophyll_Imager implements PlugIn {
	...
	public void startDialog(){ //user dialog to get dimensions and color refs
		...
		gd.addNumericField("Number of data rows: ",1,0);
		gd.addNumericField("Number of data columns: ",1,0);
		gd.addMessage("-- RGB value of the ColorChecker white panel --");
		gd.addNumericField("r =",172.633,3);
		gd.addNumericField("g =",171.633,3);
		gd.addNumericField("b =",177.633,3);
